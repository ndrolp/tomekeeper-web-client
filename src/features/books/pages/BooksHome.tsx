...
export const BooksHome = () => {
    ...
    useEffect(() => {
        ...
        const areParamsEqual =
            initialParams.toString() === searchParams.toString()
    ...
    return (
        <div className="flex w-full relative bg-background h-full">
            ...
            <aside className=" hidden w-full border-l bg-background px-0 md:block md:w-[340px] relative top-0 z-50">
                <div className="top-0 sticky  z-50 bg-background">
                    <p className="text-lg font-bold  border-b p-4 pb-4">
                        Filters
                    </p>
                    <div className="p-4 space-y-4">
                        <p className="text-lg mb-2 text-start font-bold">
                            Genres
                        </p>
                        <Collapsible>
                            <div className="space-y-2">
                                <CollapsibleContent>
                                    {filters.data?.genres.map(
                                        (genre, index) => (
                                ...
                                <CollapsibleTrigger asChild>
                                    <Button
                                        variant="ghost"
                                        className="w-full font-bold min-h-2"
                                    >
                                        ...
                                    </Button>
                                </CollapsibleTrigger>
